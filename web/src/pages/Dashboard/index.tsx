    ...
    <div>
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
        {[
          ...
          { label: '用户数量', value: stats.userCount, icon: <TeamOutlined />, color: '#ffb800' }].map((item, i) => (
          <Col span={6} key={item.label}>
            <IceCrystalCard hoverEffect="glow" animation="fadeInUp" style={{ border: `1px solid ${item.color}33`}}>
      ...
      <Row gutter={[16, 16]}>
        <Col span={16}>
          <IceCrystalCard hoverEffect="none" animation="fadeInUp" title="近 7 天对话趋势" style={{ }}>
            <ReactECharts option={chartOption} style={{ height: 280 }} />
          </IceCrystalCard>
        </Col>
        <Col span={8}>
          <IceCrystalCard hoverEffect="none" animation="fadeInUp" title="快捷操作" style={{ }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[
                ...
                { label: '系统设置', icon: <SettingOutlined />, path: '/settings' }].map((item) => (
